...
fn main() {
    ...
    let circuit_filepath = format!("circuits/toy_sample/{}.r1cs", group_name);
    for witness_gen_filepath in [
        format!("circuits/toy_sample/toy_cpp/{}", group_name),
        format!("circuits/toy_sample/toy_js/{}.wasm", group_name),
    ] {
